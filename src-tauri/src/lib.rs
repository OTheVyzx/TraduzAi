...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::project::snapshot_image_layer,
            ...
            commands::project::write_healing_mask,
            commands::project::heal_inpaint_region,
            ...
            commands::studio_lite::studio_lite_detect_page,
