...
export function BootSplash({ progress, message }: BootSplashProps) {
  ...
  return (
    <div className="relative flex h-screen items-center justify-center overflow-hidden bg-[#07070b]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(255,93,128,0.18),_transparent_40%),radial-gradient(circle_at_bottom,_rgba(108,92,231,0.12),_transparent_32%)]" />
      ...
      <div className="relative w-[min(420px,calc(100vw-40px))] rounded-2xl border border-border bg-black/70 px-8 py-10 shadow-[0_24px_90px_rgba(0,0,0,0.5)] backdrop-blur-xl">
        <div className="mx-auto w-fit rounded-full border border-border bg-white/[0.03] px-3 py-1 text-[10px] uppercase tracking-[0.28em] text-white/45">
          Boot
        </div>
